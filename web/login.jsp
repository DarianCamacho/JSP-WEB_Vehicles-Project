QAAWSSEDX CCX X XS X X XX<%-- 
    Document   : login.jsp
    Created on : 2 dic. 2022, 8:42:27
    Author     : sebas
--%>
    ...
    <body>
        <div class="card" style="width: 18rem; background-color: #000d1a; border-radius: 10px; width: 400px">
            <div class="card-body ">
                ...
                <div class="center">
                    <img src="Images/MainLogo.jpg" alt="" width="280" height="100">
                </div>
                <div class="form-floating mb-3">
                    <form action="confirmUser.jsp">
                        ...
                        <pre class="center" style="color: white;font-size: 16px"> <i>Correo: </i></pre>
                        <div class="">
                        ...
                        <div class="">
                            ...
                            <center><a href="UpdateUser.jsp">Cambie de Correo</a></center>
                        </div>
                        <div class="">
                            <center><a href="showCars.jsp">Ver lista de Vehículos Disponibles</a></center>
                        </div>
                        <div class="">
                            <center><a href="registroUsuario.html">Registrarse</a></center>
                        </div>
                        <input type="submit" value="Ingresar" style="background-color: #000099">
                    </form>
                </div>
            </div>
        </div>
